...
- [Xây dựng app đầu tiên của bạn]({{ site.baseurl }}/vi/app): 45p - 1h30p
  * Mentor:
...
- [Đưa chương trình của bạn lên Github]({{ site.baseurl }}/vi/github): 15p - 45p
  * Mentor:
...
- [Đưa app của bạn online - Heroku]({{ site.baseurl }}/vi/heroku): 15p - 45p
  * Mentor:
    - Không cần demo
